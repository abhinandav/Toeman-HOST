...
def send_otp(request):
    ...
    send_mail("otp for sign up", s, 'abhinnandu35@gmail.com', [email], fail_silently=False)
...
def resend_otp(request):
    ...
    print(new_otp)
    email = request.session.get('email')
    send_mail("New OTP for Sign Up", new_otp, settings.EMAIL_HOST, [email], fail_silently=False)
